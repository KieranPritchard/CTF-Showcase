function Welcome() {
    return (
        // Introductory banner shown at the top of the homepage.
        // Styled to match the neon cyber theme used across the site.
        <div className="bg-[#121A22] border-2 border-[#00FF88] w-full max-w-3xl mx-auto py-4 px-4 sm:px-8 mb-15 rounded-lg shadow-[0_0_20px_#00FF88,0_0_40px_#00FF88,0_0_60px_#00FF88]">
            ...
            {/* Main heading introducing the write-ups section */}
            ...
            {/* Short description explaining the purpose of the website */}
